        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    <li><a href="settings.php"><span class="glyphicon glyphicon-cog"></span> <?php echo $_SESSION['email']; ?></a></li>
                    ...
                    if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']) {
                        ...
                        ?>
                        <li><a href="admin_dashboard.php"><span class="glyphicon glyphicon-user"></span> Admin Dashboard</a></li>
                        <?php
                    }
                } else {
                    ?>
